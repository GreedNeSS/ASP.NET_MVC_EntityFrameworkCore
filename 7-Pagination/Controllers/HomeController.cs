...
using _7_Pagination.Models;

namespace _7_Pagination.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> IndexAsync(int page = 1)
        {
            ...
            var items = await users.Take(pageSize).ToListAsync();
            IndexViewModel viewModel = new IndexViewModel(items, new PageViewModel(total, page, pageSize));
